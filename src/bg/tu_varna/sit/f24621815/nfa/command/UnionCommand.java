...
/**
 * Команда за построяване на обединение на два автомата.
 *
...
public class UnionCommand implements Command {
    ...
    /**
     * Създава нова инстанция на {@code UnionCommand}.
     *
     * @param automatonService услугата за управление на заредените автомати
     * @param operationService услугата за езикови операции
     */
    public UnionCommand(AutomatonService automatonService, OperationService operationService) {
        this.automatonService = automatonService;
        this.operationService = operationService;
    }

    /**
     * Строи обединението на двата автомата и го добавя към списъка.
     *
    ...
    public void execute(String[] args) {
        ...
        Automaton result = operationService.union(a1, a2, newId);
